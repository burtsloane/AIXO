...
class SS_ROVCharging : public MSJ_Powered_OnOff {
public: 
    SS_ROVCharging(const FString& Name, ASubmarineState* InSubState, float X, float Y, float InW=150, float InH=24)
	...
	virtual FString GetTypeString() const override { return TEXT("SS_ROVCharging"); }
}; 
