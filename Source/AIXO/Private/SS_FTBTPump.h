...
class SS_FTBTPump : public PWRJ_MultiSelectJunction
{
protected:
    ICH_Pump *PumpPart;
...
public:
    SS_FTBTPump(const FString& Name, ASubmarineState* InSubState, float InX, float InY, float InW=150, float InH=24)
	...
	virtual FString GetTypeString() const override { return TEXT("SS_FTBTPump"); }

    virtual float GetLevel()
    {
    	return SubState->ForwardTBTLevel;
    }

    virtual void SetLevel(float val)
    {
		SubState->ForwardTBTLevel = val;
    }
